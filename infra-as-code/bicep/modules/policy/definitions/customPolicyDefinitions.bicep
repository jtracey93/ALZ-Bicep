...
var varCustomPolicyDefinitionsArray = [
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_append_appservice_httpsonly.json')
  }
  {
    name: 'Append-AppService-latestTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_append_appservice_latesttls.json')
  }
  {
    name: 'Append-KV-SoftDelete'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_append_kv_softdelete.json')
  }
  {
    name: 'Append-Redis-disableNonSslPort'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_append_redis_disablenonsslport.json')
  }
  {
    name: 'Append-Redis-sslEnforcement'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_append_redis_sslenforcement.json')
  }
  {
    name: 'Audit-MachineLearning-PrivateEndpointId'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_audit_machinelearning_privateendpointid.json')
  }
  {
    name: 'Deny-AA-child-resources'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_aa_child_resources.json')
  }
  {
    name: 'Deny-AppGW-Without-WAF'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_appgw_without_waf.json')
  }
  {
    name: 'Deny-AppServiceApiApp-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_appserviceapiapp_http.json')
  }
  {
    name: 'Deny-AppServiceFunctionApp-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_appservicefunctionapp_http.json')
  }
  {
    name: 'Deny-AppServiceWebApp-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_appservicewebapp_http.json')
  }
  {
    name: 'Deny-Databricks-NoPublicIp'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_databricks_nopublicip.json')
  }
  {
    name: 'Deny-Databricks-Sku'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_databricks_sku.json')
  }
  {
    name: 'Deny-Databricks-VirtualNetwork'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_databricks_virtualnetwork.json')
  }
  {
    name: 'Deny-MachineLearning-Aks'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_aks.json')
  }
  {
    name: 'Deny-MachineLearning-Compute-SubnetId'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_compute_subnetid.json')
  }
  {
    name: 'Deny-MachineLearning-Compute-VmSize'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_compute_vmsize.json')
  }
  {
    name: 'Deny-MachineLearning-ComputeCluster-RemoteLoginPortPublicAccess'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_computecluster_remoteloginportpublicaccess.json')
  }
  {
    name: 'Deny-MachineLearning-ComputeCluster-Scale'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_computecluster_scale.json')
  }
  {
    name: 'Deny-MachineLearning-HbiWorkspace'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_hbiworkspace.json')
  }
  {
    name: 'Deny-MachineLearning-PublicAccessWhenBehindVnet'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_publicaccesswhenbehindvnet.json')
  }
  {
    name: 'Deny-MachineLearning-PublicNetworkAccess'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_machinelearning_publicnetworkaccess.json')
  }
  {
    name: 'Deny-MySql-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_mysql_http.json')
  }
  {
    name: 'Deny-PostgreSql-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_postgresql_http.json')
  }
  {
    name: 'Deny-Private-DNS-Zones'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_private_dns_zones.json')
  }
  {
    name: 'Deny-PublicEndpoint-MariaDB'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_publicendpoint_mariadb.json')
  }
  {
    name: 'Deny-PublicIP'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_publicip.json')
  }
  {
    name: 'Deny-RDP-From-Internet'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_rdp_from_internet.json')
  }
  {
    name: 'Deny-Redis-http'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_redis_http.json')
  }
  {
    name: 'Deny-Sql-minTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_sql_mintls.json')
  }
  {
    name: 'Deny-SqlMi-minTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_sqlmi_mintls.json')
  }
  {
    name: 'Deny-Storage-minTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_storage_mintls.json')
  }
  {
    name: 'Deny-Subnet-Without-Nsg'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_subnet_without_nsg.json')
  }
  {
    name: 'Deny-Subnet-Without-Udr'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_subnet_without_udr.json')
  }
  {
    name: 'Deny-VNET-Peer-Cross-Sub'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_vnet_peer_cross_sub.json')
  }
  {
    name: 'Deny-VNET-Peering-To-Non-Approved-VNETs'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_vnet_peering_to_non_approved_vnets.json')
  }
  {
    name: 'Deny-VNet-Peering'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deny_vnet_peering.json')
  }
  {
    name: 'Deploy-ASC-SecurityContacts'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_asc_securitycontacts.json')
  }
  {
    name: 'Deploy-Budget'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_budget.json')
  }
  {
    name: 'Deploy-Custom-Route-Table'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_custom_route_table.json')
  }
  {
    name: 'Deploy-DDoSProtection'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_ddosprotection.json')
  }
  {
    name: 'Deploy-Diagnostics-AA'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_aa.json')
  }
  {
    name: 'Deploy-Diagnostics-ACI'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_aci.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_analysisservice.json')
  }
  {
    name: 'Deploy-Diagnostics-ApiForFHIR'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_apiforfhir.json')
  }
  {
    name: 'Deploy-Diagnostics-APIMgmt'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_apimgmt.json')
  }
  {
    name: 'Deploy-Diagnostics-ApplicationGateway'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_applicationgateway.json')
  }
  {
    name: 'Deploy-Diagnostics-AVDScalingPlans'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_avdscalingplans.json')
  }
  {
    name: 'Deploy-Diagnostics-Bastion'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_bastion.json')
  }
  {
    name: 'Deploy-Diagnostics-CDNEndpoints'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_cdnendpoints.json')
  }
  {
    name: 'Deploy-Diagnostics-CognitiveServices'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_cognitiveservices.json')
  }
  {
    name: 'Deploy-Diagnostics-CosmosDB'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_cosmosdb.json')
  }
  {
    name: 'Deploy-Diagnostics-Databricks'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_databricks.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_datafactory.json')
  }
  {
    name: 'Deploy-Diagnostics-DLAnalytics'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_dlanalytics.json')
  }
  {
    name: 'Deploy-Diagnostics-EventGridSub'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_eventgridsub.json')
  }
  {
    name: 'Deploy-Diagnostics-EventGridSystemTopic'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_eventgridsystemtopic.json')
  }
  {
    name: 'Deploy-Diagnostics-EventGridTopic'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_eventgridtopic.json')
  }
  {
    name: 'Deploy-Diagnostics-ExpressRoute'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_expressroute.json')
  }
  {
    name: 'Deploy-Diagnostics-Firewall'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_firewall.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_function.json')
  }
  {
    name: 'Deploy-Diagnostics-HDInsight'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_hdinsight.json')
  }
  {
    name: 'Deploy-Diagnostics-iotHub'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_iothub.json')
  }
  {
    name: 'Deploy-Diagnostics-LoadBalancer'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_loadbalancer.json')
  }
  {
    name: 'Deploy-Diagnostics-LogicAppsISE'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_logicappsise.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_mediaservice.json')
  }
  {
    name: 'Deploy-Diagnostics-MlWorkspace'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_mlworkspace.json')
  }
  {
    name: 'Deploy-Diagnostics-MySQL'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_mysql.json')
  }
  {
    name: 'Deploy-Diagnostics-NetworkSecurityGroups'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_networksecuritygroups.json')
  }
  {
    name: 'Deploy-Diagnostics-NIC'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_nic.json')
  }
  {
    name: 'Deploy-Diagnostics-PostgreSQL'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_postgresql.json')
  }
  {
    name: 'Deploy-Diagnostics-PowerBIEmbedded'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_powerbiembedded.json')
  }
  {
    name: 'Deploy-Diagnostics-RedisCache'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_rediscache.json')
  }
  {
    name: 'Deploy-Diagnostics-Relay'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_relay.json')
  }
  {
    name: 'Deploy-Diagnostics-SignalR'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_signalr.json')
  }
  {
    name: 'Deploy-Diagnostics-SQLElasticPools'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_sqlelasticpools.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_timeseriesinsights.json')
  }
  {
    name: 'Deploy-Diagnostics-TrafficManager'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_trafficmanager.json')
  }
  {
    name: 'Deploy-Diagnostics-VirtualNetwork'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_virtualnetwork.json')
  }
  {
    name: 'Deploy-Diagnostics-VM'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_vm.json')
  }
  {
  ...
  }
  {
    ...
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_vnetgw.json')
  }
  {
    name: 'Deploy-Diagnostics-WebServerFarm'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_webserverfarm.json')
  }
  {
    name: 'Deploy-Diagnostics-Website'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_website.json')
  }
  {
    name: 'Deploy-Diagnostics-WVDAppGroup'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_wvdappgroup.json')
  }
  {
    name: 'Deploy-Diagnostics-WVDHostPools'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_wvdhostpools.json')
  }
  {
    name: 'Deploy-Diagnostics-WVDWorkspace'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_diagnostics_wvdworkspace.json')
  }
  {
    name: 'Deploy-FirewallPolicy'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_firewallpolicy.json')
  }
  {
    name: 'Deploy-MySQL-sslEnforcement'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_mysql_sslenforcement.json')
  }
  {
    name: 'Deploy-Nsg-FlowLogs-to-LA'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_nsg_flowlogs_to_la.json')
  }
  {
    name: 'Deploy-Nsg-FlowLogs'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_nsg_flowlogs.json')
  }
  {
    name: 'Deploy-PostgreSQL-sslEnforcement'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_postgresql_sslenforcement.json')
  }
  {
    name: 'Deploy-Sql-AuditingSettings'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sql_auditingsettings.json')
  }
  {
    name: 'Deploy-SQL-minTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sql_mintls.json')
  }
  {
    name: 'Deploy-Sql-SecurityAlertPolicies'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sql_securityalertpolicies.json')
  }
  {
    name: 'Deploy-Sql-Tde'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sql_tde.json')
  }
  {
    name: 'Deploy-Sql-vulnerabilityAssessments'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sql_vulnerabilityassessments.json')
  }
  {
    name: 'Deploy-SqlMi-minTLS'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_sqlmi_mintls.json')
  }
  {
    name: 'Deploy-Storage-sslEnforcement'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_storage_sslenforcement.json')
  }
  {
    name: 'Deploy-VNET-HubSpoke'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_vnet_hubspoke.json')
  }
  {
    name: 'Deploy-Windows-DomainJoin'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_deploy_windows_domainjoin.json')
  }
]
...
var varCustomPolicySetDefinitionsArray = [
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_deny_publicpaasendpoints.json')
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_deploy_diagnostics_loganalytics.json')
    libSetChildDefinitions: [
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_deploy_mdfc_config.json')
    libSetChildDefinitions: [
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_deploy_private_dns_zones.json')
    libSetChildDefinitions: [
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_deploy_sql_security.json')
    libSetChildDefinitions: [
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_enforce_encryption_cmk.json')
    libSetChildDefinitions: [
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_enforce_encrypttransit.json')
    libSetChildDefinitions: [
      {
